...
export function QuickCapture() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('[Client] AI 분류 요청:', content.substring(0, 50))

      const classification = await classifyNodeAction(content.trim())

      console.log('[Client] AI 분류 결과:', classification)
      ...
      if (classification) {
        ...
        // AI 분류 실패 시 기본 저장
        console.log('[Client] AI 분류 실패, 기본 저장으로 진행')
